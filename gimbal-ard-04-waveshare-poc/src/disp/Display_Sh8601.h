...
private:
    ...
    static esp_err_t displayDel(esp_lcd_panel_t* panel);
    static esp_err_t displayReset(esp_lcd_panel_t* panel);
    static esp_err_t displayInit(esp_lcd_panel_t* panel);
    static esp_err_t displayDrawBitmap(esp_lcd_panel_t* panel, int x_start, int y_start, int x_end, int y_end, const void* color_data);
    static esp_err_t displayInvertColor(esp_lcd_panel_t* panel, bool invert_color_data);
    static esp_err_t displayMirror(esp_lcd_panel_t* panel, bool mirror_x, bool mirror_y);
    static esp_err_t displaySwapXY(esp_lcd_panel_t* panel, bool swap_axes);
    static esp_err_t displaySetGap(esp_lcd_panel_t* panel, int x_gap, int y_gap);
