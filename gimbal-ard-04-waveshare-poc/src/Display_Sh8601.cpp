...
esp_err_t Display_Sh8601::panel_sh8601_del(esp_lcd_panel_t* panel) {
...
esp_err_t Display_Sh8601::panel_sh8601_reset(esp_lcd_panel_t* panel) {
    sh8601_panel_t* sh8601 = __containerof(panel, sh8601_panel_t, base);
...
esp_err_t Display_Sh8601::panel_sh8601_init(esp_lcd_panel_t* panel) {
...
esp_err_t Display_Sh8601::panel_sh8601_draw_bitmap(esp_lcd_panel_t* panel, int x_start, int y_start, int x_end, int y_end, const void* color_data) {
...
esp_err_t Display_Sh8601::panel_sh8601_invert_color(esp_lcd_panel_t* panel, bool invert_color_data) {
    sh8601_panel_t* sh8601 = __containerof(panel, sh8601_panel_t, base);
    esp_lcd_panel_io_handle_t io = sh8601->io;
    int command = 0;
...
esp_err_t Display_Sh8601::panel_sh8601_mirror(esp_lcd_panel_t* panel, bool mirror_x, bool mirror_y) {
...
esp_err_t Display_Sh8601::panel_sh8601_swap_xy(esp_lcd_panel_t* panel, bool swap_axes) {
    ESP_LOGE(TAG, "swap_xy is not supported by this panel");
    return ESP_ERR_NOT_SUPPORTED;
}

esp_err_t Display_Sh8601::panel_sh8601_set_gap(esp_lcd_panel_t* panel, int x_gap, int y_gap) {
    sh8601_panel_t* sh8601 = __containerof(panel, sh8601_panel_t, base);
    sh8601->x_gap = x_gap;
    sh8601->y_gap = y_gap;
    return ESP_OK;
